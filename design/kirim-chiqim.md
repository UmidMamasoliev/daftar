...
0048, 0049, 0050, 0051, 0057, 0063 → 0067.
...
**Navigatsiya (0067):** «Yangi yozuv» formasi **bosh sahifadagi «＋ Yozuv»** tugmasidan
ochiladi — navigatsiyada alohida «Yozuv» bandi yoʻq. «Yozuvlar» ekrani navigatsiya
panelining **«Yozuvlar»** boʻlimi (tavsifi `design/uslub.md`); bosh sahifadagi
**«Hammasi ›»** havolasi ham oʻsha ekranga olib boradi. «Kategoriyalar» ga esa faqat
«Yangi yozuv» formasidan kiriladi.
...
Yuqorida sarlavha **«Yozuvlar»**. Bu ekran navigatsiyaning oʻz boʻlimi (0067), shuning
uchun chapda **«‹ Orqaga»** havolasi yoʻq — bosh sahifadagi «Hammasi ›» dan kirilganda ham
qoʻyilmaydi: qaytish yoʻli navigatsiyadagi **«Bosh»** bandi.
...
- Panel faqat **«Yozuvlar»** ekranida chiqadi (0029, 20-mezon): bosh sahifadagi qisqa
  roʻyxatdan oʻchirish yoʻli yoʻq — u yerda qatorlar bosilmaydi (0067).
- Panel pastdagi navigatsiya panelining ustida turadi — qatlamlar tartibi
  `design/uslub.md` dagi «Pastdagi panellar tartibi» boʻlimida (0067).
...
Bu holatda ham qoʻshish tugmasi qoʻyilmaydi — u bosh sahifada (0067). Hamma yozuv
oʻchirilganda ham xuddi shu holat koʻrinadi; agar «qaytarish» paneli turgan boʻlsa, u boʻsh
holat ustida turadi.
